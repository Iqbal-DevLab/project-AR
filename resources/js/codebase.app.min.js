            ...
            return (
                ...
                (n = [
                            ...
                            var a = this,
                                ...
                                n = {
                                    ...
                                    "table-tools": function () {
                                        a.tableToolsSections(),
                                            a.tableToolsCheckable();
                                    },
                        ...
                        value: function () {
                            jQuery(
                                ...
                                .on("click.cb.helpers.core", function (e) {
                                    ...
                                    a
                                        .addClass("js-class-toggle-enabled")
                                        .blur(),
                                        jQuery(
                                            a.data("target").toString()
                                        ).toggleClass(
                        ...
                        value: function () {
                            jQuery(
                                ...
                                var a = jQuery("#page-header"),
                                    ...
                                    l =
                                        a.length &&
                                        jQuery("#page-container").hasClass(
                                            "page-header-fixed"
                                        )
                                            ? a.outerHeight()
                                            : 0;
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = jQuery(
                                ".js-year-copy:not(.js-year-copy-enabled)"
                            );
                            if (e.length > 0) {
                        ...
                        value: function () {
                            jQuery(
                                ...
                                n.addClass("js-appear-enabled").appear(
                                    function () {
                                        setTimeout(function () {
                                            n.removeClass("invisible").addClass(
                                                l
                                            );
                                        }, i);
                                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            jQuery(
                                '[data-toggle="countTo"]:not(.js-count-to-enabled)'
                            ).each(function (e, a) {
                                var t = jQuery(a),
                                    n = t.data("after"),
                                    o = t.data("before");
                                t.addClass("js-count-to-enabled").appear(
                                    function () {
                                        t.countTo({
                                            speed: t.data("speed") || 1500,
                                            refreshInterval:
                                                t.data("refresh-interval") ||
                                                15,
                                            onComplete: function () {
                                                n
                                                    ? t.html(t.html() + n)
                            ...
                            jQuery(
                                ...
                                n.addClass("js-table-checkable-enabled"),
                                    ...
                                    jQuery(
                                        ...
                                        n
                                    ).on("click.cb.helpers", function (a) {
                    ...
                    },
                    {
                        key: "contentFilter",
                        value: function () {
                            jQuery(".js-filter:not(.js-filter-enabled)").each(
                                function (e, a) {
                                    var t,
                                        n = jQuery(a),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            jQuery(
                                ...
                                jQuery("#js-ckeditor:not(.js-ckeditor-enabled)")
                                    .length &&
                            ...
                            jQuery(".js-slider:not(.js-slider-enabled)").each(
                                function (e, a) {
                                    ...
                                    t.addClass("js-slider-enabled").slick({
                                        ...
                                        dots: t.data("dots") || !1,
                                        slidesToShow:
                                            t.data("slides-to-show") || 1,
                                        slidesToScroll:
                                            t.data("slides-to-scroll") || 1,
                                        centerMode: t.data("center-mode") || !1,
                                        autoplay: t.data("autoplay") || !1,
                                        autoplaySpeed:
                                            t.data("autoplay-speed") || 3e3,
                                        infinite:
                                            void 0 === t.data("infinite") ||
                                            t.data("infinite"),
                                    });
                                }
                            );
                    ...
                    },
                    {
                        ...
                        value: function () {
                            jQuery(
                                ".js-tags-input:not(.js-tags-input-enabled)"
                            ).each(function (e, a) {
                                var t = jQuery(a);
                                t.addClass("js-tags-input-enabled").tagsInput({
                                    ...
                                    defaultText:
                                        t.data("default-text") || "Add tag",
                                    removeWithBackspace:
                                        t.data("remove-with-backspace") || !0,
                                    delimiter: [","],
                                });
                            });
                        },
                        ...
                        value: function () {
                            jQuery(
                                ...
                                t.addClass("js-pie-chart-enabled").easyPieChart(
                                    {
                                        barColor:
                                            t.data("bar-color") || "#777777",
                                        trackColor:
                                            t.data("track-color") || "#eeeeee",
                        ...
                        value: function () {
                            jQuery(
                                ...
                                t.addClass("js-maxlength-enabled").maxlength({
                                    ...
                                    warningClass:
                                        t.data("warning-class") ||
                                        "badge badge-warning",
                                    limitReachedClass:
                                        t.data("limit-reached-class") ||
                                        "badge badge-danger",
                        ...
                        value: function () {
                            this._lPage.hasClass("side-scroll")
                                ? (this._lSidebar.length > 0 &&
                                      ...
                                      ((this._lSidebarScroll = new SimpleBar(
                                          this._lSidebar[0]
                                      )),
                                      jQuery(
                                  ...
                                  this._lSideOverlay.length > 0 &&
                                      ...
                                      ((this._lSideOverlayScroll =
                                          new SimpleBar(this._lSideOverlay[0])),
                                      jQuery(
                                          ".simplebar-scroll-content",
                                          this._lSideOverlay
                                      ).scrollLock("enable")))
                                                ...
                                                clearTimeout(e),
                                                    (e = setTimeout(function (
                                                        ...
                                                        var t =
                                                            ...
                                                            n =
                                                                a._lHeader.outerHeight() ||
                                                                0,
                                                            o =
                                                                a._lFooter.outerHeight() ||
                                                                0;
                                                        a._lPage.hasClass(
                                                            "page-header-fixed"
                                                        ) ||
                        ...
                        value: function () {
                            ...
                            var t = {
                                ...
                                sidebar_mini_toggle: function () {
                                    a._windowW > 991 &&
                                        a._lPage.toggleClass("sidebar-mini");
                                },
                                sidebar_mini_on: function () {
                                    a._windowW > 991 &&
                                        a._lPage.addClass("sidebar-mini");
                                },
                                sidebar_mini_off: function () {
                                    a._windowW > 991 &&
                                        a._lPage.removeClass("sidebar-mini");
                                },
