...
!(function (n) {
    ...
    var p,
            ...
            (this.$ = function (t, e) {
                ...
                (this.fnAddData = function (t, e) {
                    var n = this.api(!0),
                        a =
                            U.isArray(t) &&
                            (U.isArray(t[0]) || U.isPlainObject(t[0]))
                                ? n.rows.add(t)
                                : n.row.add(t);
            ...
            return (
                this.each(function () {
                    ...
                    if ("table" == this.nodeName.toLowerCase()) {
                        ...
                        if (
                            (0 !== m.length &&
                                (ct(f.aoHeader, m[0]), (S = ft(f))),
                            null === i.aoColumns)
                        )
                            for (v = [], l = 0, o = S.length; l < o; l++)
                                v.push(null);
                        else v = i.aoColumns;
                        ...
                        var y = f.oFeatures,
                            _ = function () {
                                ...
                                var e = u.children("caption").each(function () {
                                        this._captionSide =
                                            U(this).css("caption-side");
                                    }),
                                    n = u.children("thead");
                                0 === n.length &&
                                    (n = U("<thead/>").appendTo(u)),
                                    (f.nTHead = n[0]);
                                var a = u.children("tbody");
                                0 === a.length &&
                                    (a = U("<tbody/>").appendTo(u)),
                                    (f.nTBody = a[0]);
                                ...
                                if (
                                    ...
                                    0 === r.length || 0 === r.children().length
                                        ...
                                        : 0 < r.length &&
                                          ((f.nTFoot = r[0]),
                                          ct(f.aoFooter, f.nTFoot)),
                                    i.aaData)
                                )
                                    for (l = 0; l < i.aaData.length; l++)
                                        W(f, i.aaData[l]);
                                else
        ...
        f = function (t, e, n) {
            return (
                !!s(t) ||
                ((s((a = t)) || "string" == typeof a) && !!c(d(t), e, n)) ||
                null
            );
            var a;
        },
    ...
    function H(t, e, n) {
        ...
        (a._bAttrSrc =
            U.isPlainObject(l) && (c(l.sort) || c(l.type) || c(l.filter))),
            (a._setter = null),
            ...
            t.oFeatures.bSort ||
                ((a.bSortable = !1), o.addClass(r.sSortableNone));
        ...
        a.bSortable && (f || d)
            ? f && !d
                ...
                : ((a.sSortingClass = r.sSortable),
                  (a.sSortingClassJUI = r.sSortJUI))
            ...
            for (r = e.length - 1; 0 <= r; r--) {
                ...
                for (U.isArray(d) || (d = [d]), i = 0, l = d.length; i < l; i++)
                    if ("number" == typeof d[i] && 0 <= d[i]) {
                        ...
                        a(d[i], c);
                    } else if ("number" == typeof d[i] && d[i] < 0)
                        a(f.length + d[i], c);
                    else if ("string" == typeof d[i])
                        for (s = 0, u = f.length; s < u; s++)
                            ("_all" == d[i] || U(f[s].nTh).hasClass(d[i])) &&
                                a(s, c);
            }
    ...
    function et(n, a, t, e) {
        ...
        if ("dom" !== t && ((t && "auto" !== t) || "dom" !== i.src)) {
            ...
            if (s)
                if (e !== V) l(s[e], e);
                else for (r = 0, o = s.length; r < o; r++) l(s[r], r);
    ...
    function ot(t) {
        ...
        if (
            ...
            for (e = 0, n = f.length; e < n; e++)
                ((o = c[e]).nTf = f[e].cell),
                    o.sClass && U(o.nTf).addClass(o.sClass);
        }
    }
    function it(t, e, n) {
        var a,
        ...
        if (-1 === U.inArray(!1, e)) {
            ...
            if (0 !== u.length)
                for (
                    ...
                    fe(t, "aoRowCallback", null, [v, b._aData, a, p, g]),
                        n.push(v),
                        a++;
                }
            else {
    ...
    function ut(t) {
        ...
        for (
            var i, l, s, u, c, f, d = t.sDom.split(""), h = 0;
            h < d.length;
            h++
        ) {
            if (((i = null), "<" == (l = d[h]))) {
    ...
    function dt(r, t, e) {
        ...
        if (U.isPlainObject(a) && a.data) {
            ...
            (t = "function" == typeof n && u ? u : U.extend(!0, t, u)),
                delete a.data;
        }
        var c = {
            data: t,
        ...
        (r.oAjaxData = t),
            ...
            r.fnServerData
                ...
                : r.sAjaxSource || "string" == typeof a
                ? (r.jqXHR = U.ajax(U.extend(c, { url: a || r.sAjaxSource })))
                : "function" == typeof a
                ? (r.jqXHR = a.call(l, t, s, r))
                : ((r.jqXHR = U.ajax(U.extend(c, a))), (a.data = n));
    }
    function ht(e) {
        return (
            !e.bAjaxDataGet ||
        ...
        for (e = 0; e < i; e++)
            (a = o[e]),
                ...
                l.bFilter &&
                    ...
                    p("bSearchable_" + e, a.bSearchable)),
                l.bSort && p("bSortable_" + e, a.bSortable);
        l.bFilter && (p("sSearch", s.sSearch), p("bRegex", s.bRegex)),
            l.bSort &&
                ...
                for (i = [], a = 0, o = u.length; a < o; a++)
                    (e = u[a]).bSearchable
                        ...
                        l.indexOf &&
                            -1 !== l.indexOf("&") &&
                            ((Tt.innerHTML = l),
                            (l = wt ? Tt.textContent : Tt.innerText)),
    ...
    function Lt(t) {
        ...
        if (0 !== e.length) {
            ...
            null !== s && (l = s.call(t.oInstance, t, a, r, o, i, l)),
                U(e).html(l);
        }
    }
    function Rt(t, e) {
    ...
    function Et(t) {
        ...
        return (
            ...
            U(b).css(r && n.bCollapse ? "max-height" : "height", r),
            (t.nScrollHead = g),
            (t.nScrollBody = b),
            (t.nScrollFoot = v),
    ...
    function Bt(n) {
        ...
        (n.scrollBarVis = M),
            ...
            F &&
                ((i = F.clone().prependTo(x)),
                (e = F.find("tr")),
                (r = i.find("tr"))),
            (o = w.clone().prependTo(x)),
            (t = w.find("tr")),
            (a = o.find("tr")),
            o.find("th, td").removeAttr("tabindex"),
            f || ((_.width = "100%"), (g[0].style.width = "100%")),
            U.each(ft(n, o), function (t, e) {
            ...
            "" === f
                ? ((A.width = "100%"),
                  R &&
                      (x.find("tbody").height() > D.offsetHeight ||
                          "scroll" == y.css("overflow-y")) &&
                      (A.width = zt(x.outerWidth() - p)),
                  (u = x.outerWidth()))
                : "" !== d && ((A.width = zt(d)), (u = x.outerWidth())),
            Ut(k, a),
            Ut(function (t) {
            ...
            F &&
                Ut(function (t, e) {
                    (t.innerHTML =
                        '<div class="dataTables_sizing">' + O[e] + "</div>"),
                        (t.childNodes[0].style.height = "0"),
                        (t.childNodes[0].style.overflow = "hidden"),
                        (t.style.width = N[e]);
                }, r),
            ...
            (_.width = zt(s)),
            (b.width = zt(s)),
            F && (n.nScrollFoot.style.width = zt(s)),
            h || (R && (_.height = zt(I.offsetHeight + p)));
        var W = x.outerWidth();
        ...
        (S[B] = E ? p + "px" : "0px"),
            F &&
                ...
                (C[0].style.width = zt(W)),
                (C[0].style[B] = E ? p + "px" : "0px")),
            x.children("colgroup").insertBefore(x.children("thead")),
            y.scroll(),
            (!n.bSorted && !n.bFiltered) || n._drawHold || (D.scrollTop = 0);
    }
    function Ut(t, e, n) {
    ...
    function Yt(t) {
        ...
        for (
            ...
            for (n = 0, a = (r = u[(l = d[e][0])].aDataSort).length; n < a; n++)
                (i = u[(o = r[n])].sType || "string"),
                    d[e]._idx === V &&
                        (d[e]._idx = U.inArray(d[e][1], u[o].asSorting)),
                    s.push({
                        src: l,
                        col: o,
                        dir: d[e][1],
    ...
    function Qt(t, e, n, a) {
        ...
        if (
            ...
            -1 !== u
                ? (null === (r = s(i[u], !0)) && 1 === i.length && (r = 0),
                  null === r
                      ? i.splice(u, 1)
                      : ((i[u][1] = l[r]), (i[u]._idx = r)))
    ...
    function ee(t) {
        ...
        if (l.bSort && l.bSortClasses) {
            for (e = 0, n = r.length; e < n; e++)
                (a = r[e].src),
                    U(X(t.aoData, "anCells", a)).removeClass(
                        o + (e < 2 ? e + 1 : 3)
                    );
            for (e = 0, n = i.length; e < n; e++)
                (a = i[e].src),
                    U(X(t.aoData, "anCells", a)).addClass(
                        o + (e < 2 ? e + 1 : 3)
                    );
        }
        t.aLastSort = i;
    ...
    function ne(t, e) {
        ...
        for (
            var l = I.ext.type.order[o.sType + "-pre"],
                s = 0,
                u = t.aoData.length;
            s < u;
            s++
    ...
    function re(r, t, o) {
        var i,
            ...
            e = function (t) {
                if (t && t.time) {
                    var e = fe(r, "aoStateLoadParams", "stateLoadParams", [
                        r,
                        t,
                    ]);
                    if (-1 === U.inArray(!1, e)) {
                        ...
                        else if (t.columns && s.length !== t.columns.length)
                            o();
                        else {
                            if (
                                ...
                                t.length !== V &&
                                    (r._iDisplayLength = t.length),
                                t.order !== V &&
                                    ((r.aaSorting = []),
                                    U.each(t.order, function (t, e) {
                                        r.aaSorting.push(
                                            e[0] >= s.length ? [0, e[1]] : e
                                        );
                                    })),
                                t.search !== V &&
                                    U.extend(r.oPreviousSearch, At(t.search)),
                                t.columns)
                            )
                                for (i = 0, l = t.columns.length; i < l; i++) {
                                    var a = t.columns[i];
                                    a.visible !== V &&
                                        (s[i].bVisible = a.visible),
                                        a.search !== V &&
                                            U.extend(
                                                r.aoPreSearchCols[i],
                                                At(a.search)
                ...
                for (a = 0, r = n.length; a < r; a++)
                    (e[(o = n[a]).name] =
                        "function" == typeof o.val
                            ? i(t, o.val, o)
                            : U.isPlainObject(o.val)
                            ? {}
                            : o.val),
                        (e[o.name].__dt_wrapper = !0),
                        m.extend(t, e[o.name], o.propExt);
            }
        }),
        (m.register = e =
            function (t, e) {
    ...
    var Se = function (t, e, n, a, r) {
            var o,
                ...
                d = typeof e;
            for (
                (e && "string" !== d && "function" !== d && e.length !== V) ||
                    (e = [e]),
                    l = 0,
                    s = e.length;
                l < s;
        ...
        me = function (t) {
            return (
                t || (t = {}),
                t.filter && t.search === V && (t.search = t.filter),
        ...
        ye = function (t, e) {
            ...
            if ("current" == s)
                for (c = t._iDisplayStart, f = t.fnDisplayEnd(); c < f; c++)
                    a.push(r[c]);
                    ...
                    function (n) {
                        ...
                        if (n.nodeName) {
                            var e = n._DT_RowIndex,
                                r = n._DT_CellIndex;
                            if (e !== V)
                                return a[e] && a[e].nTr === n ? [e] : [];
                            if (r)
                                return a[r.row] && a[r.row].nTr === n
                                    ? [r.row]
                                    : [];
    ...
    e("cells()", function (b, t, v) {
        ...
        return U.extend(e.selector, { cols: t, rows: b, opts: v }), e;
    }),
            ...
            function (t) {
                ...
                return (
                    ...
                    (U.each(I.settings, function (t, e) {
                        var n = e.nScrollHead
                                ? U("table", e.nScrollHead)[0]
                                : null,
                            a = e.nScrollFoot
                                ? U("table", e.nScrollFoot)[0]
                                : null;
    ...
    function Le(t, e) {
        ...
        return (
            e <= a
                ? (n = g(0, e))
                : t <= r
                ? ((n = g(0, a - 2)).push("ellipsis"), n.push(e - 1))
                : (e - 1 - r <= t
                      ? (n = g(e - (a - 2), e)).splice(0, 0, "ellipsis")
                      : ((n = g(t - r + 2, t + r - 1)).push("ellipsis"),
                        n.push(e - 1),
    ...
    U.extend(Fe, {
        ...
        U.extend(I.ext.type.detect, [
            ...
            function (t, e) {
                return s(t) || ("string" == typeof t && -1 !== t.indexOf("<"))
                    ? "html"
                    : null;
            },
        ]),
            ...
            header: {
                ...
                jqueryui: function (o, i, l, s) {
                    U("<div/>")
                        ...
                        .append(
                            U("<span/>").addClass(
                                s.sSortIcon + " " + l.sSortingClassJUI
                            )
                        )
                        .appendTo(i),
                        U(o.nTable).on("order.dt.DT", function (t, e, n, a) {
