                    ...
                    <div class="row no-gutters text-center mb-5">
                        ...
                        <div class="col-2 mb-5">
                            <a class="text-elegance" data-toggle="theme"
                                data-theme="{{ asset('/') }}css/themes/elegance.min.css" href="javascript:void(0)">
                                <i class="fa fa-2x fa-circle"></i>
                            </a>
                        </div>
                        <div class="col-2 mb-5">
                            <a class="text-pulse" data-toggle="theme"
                                data-theme="{{ asset('/') }}css/themes/pulse.min.css" href="javascript:void(0)">
                                <i class="fa fa-2x fa-circle"></i>
                            </a>
                        </div>
                        <div class="col-2 mb-5">
                            <a class="text-flat" data-toggle="theme"
                                data-theme="{{ asset('/') }}css/themes/flat.min.css" href="javascript:void(0)">
                                <i class="fa fa-2x fa-circle"></i>
                            </a>
                        </div>
                        <div class="col-2 mb-5">
                            <a class="text-corporate" data-toggle="theme"
                                data-theme="{{ asset('/') }}css/themes/corporate.min.css" href="javascript:void(0)">
                                <i class="fa fa-2x fa-circle"></i>
                            </a>
                        </div>
                        <div class="col-2 mb-5">
                            <a class="text-earth" data-toggle="theme"
                                data-theme="{{ asset('/') }}css/themes/earth.min.css" href="javascript:void(0)">
                                <i class="fa fa-2x fa-circle"></i>
                            </a>
                        </div>
                    </div>
        ...
        <div class="content-header-section">
            <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu dropdown-menu-right min-width-200"
                    ...
                    <h5 class="h6 text-center py-10 mb-5 text-uppercase">User</h5>
                    ...
                    <a class="dropdown-item" href="javascript:void(0)">
                        <i class="si si-note mr-5"></i> invoice
                    </a>
                    <div class="dropdown-divider"></div>
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        ...
                        <button class="dropdown-item" type="submit">
                            <i class="si si-logout mr-5 btn"></i> Sign Out
                        </button>
                    </form>
                </div>
            </div>
