            ...
            return (
                ...
                (r = [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            // Check if the "no-pagination" class exists
                            var hasNoPagination = jQuery(
                                ".js-dataTable-full-pagination"
                            ).hasClass("no-pagination");
                            ...
                            // If "no-pagination" class exists, disable pagination
                            if (hasNoPagination) {
                                dataTableOptions.paging = false;
                            } else {
                                dataTableOptions.pagingType = "full_numbers";
                            }
